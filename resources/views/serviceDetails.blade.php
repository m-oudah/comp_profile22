...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center py-5">
        <h1 class="display-4 text-white animated slideInDown mb-3">{{__('trans.Service Details')}}</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a class="text-white"
                        href="{{route('index',$lang)}}">{{__('trans.home')}}</a></li>
                <li class="breadcrumb-item text-secondary active" aria-current="page">{{__('trans.service title')}}</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="container pt-5 pb-3">
        <div class="row">
            ...
            <div class="col-lg-4 col-12 text-center">
                ...
                <h6 class="section-title bg-white text-center text-primary px-3 mb-4">{{__('trans.other services')}}
                </h6>
