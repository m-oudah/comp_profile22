    ...
    <!-- Footer Start -->
    <div class="container-fluid bg-dark text-body footer mt-2 pt-2 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <h6 class="text-light mb-4">{{ __('trans.Usefull Links')}}</h6>
                 
                    <a href="{{route('index',$lang)}}" class="btn btn-link">{{__('trans.home')}}</a>
                    <a href="{{route('about',$lang)}}" class="btn btn-link">{{__('trans.About')}}</a>
                    <a href="{{route('services',$lang)}}" class="btn btn-link">{{__('trans.Services')}}</a>
                    <a href="{{route('contact',$lang)}}" class="btn btn-link">{{__('trans.Contact')}}</a>
